...
def test_create_badge_json_return_true():
    """
    Test create badge json file from python dictionary

    Expect Result: True
    """
    badge_dict = {'schemaVersion': 1, 'style': 'flat', 'label': 'test', 'labelColor': 'fff', 'message': 'x', 'color': 'fff'}
    badge_name = 'demo'
...
# def test_cicleanup_success(get_repo):
#     """
#     Test ci-cleanup
